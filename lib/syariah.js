...
export function checkSyariahStatus(rawSymbol, market) {
  if (market === "CRYPTO") {
    return {
      ...
      note:
        "Status syariah crypto tidak dinilai di app ini — kriteria DES/OJK khusus saham IDX. Kelayakan aset digital mengikuti fatwa/standar terpisah; verifikasi mandiri sebelum dipakai sebagai acuan.",
    };
  }
